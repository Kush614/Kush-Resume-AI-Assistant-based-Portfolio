...
- LinkedIn: linkedin.com/in/kush-ise/
- GitHub: github.com/Kush614
        ...
        contents: [
          {
            parts: [
              {
                text: `You are a helpful AI assistant that answers questions about the following resume. Include relevant links when discussing projects or achievements:
